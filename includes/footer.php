        ...
        <div class="site-footer__grid">
            ...
            <div class="site-footer__brand-col">
                ...
                <div class="site-footer__socials-wrap">
                    ...
                    <div class="site-footer__social-links">
                        <a href="https://www.instagram.com/rkcollection" target="_blank" rel="noopener" class="site-footer__social-icon" aria-label="Instagram">
                        ...
                        <a href="https://www.facebook.com/rkcollection" target="_blank" rel="noopener" class="site-footer__social-icon" aria-label="Facebook">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                            </svg>
                        </a>
                        <a href="https://wa.me/919876543210" target="_blank" rel="noopener" class="site-footer__social-icon" aria-label="WhatsApp">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                            </svg>
                        </a>
                        <a href="https://www.pinterest.com/rkcollection" target="_blank" rel="noopener" class="site-footer__social-icon" aria-label="Pinterest">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="site-footer__links-col">
                ...
                <ul class="site-footer__nav-list">
                    <li><a href="shop?category=banarasi">BANARASI SAREES</a></li>
                    <li><a href="shop?category=kanjivaram">KANJIVARAM SAREES</a></li>
                    <li><a href="shop?category=silk">PURE SILK SAREES</a></li>
                    <li><a href="shop?category=mangalagiri">MANGALAGIRI SAREES</a></li>
                    <li><a href="shop?category=cotton">COTTON SAREES</a></li>
                    <li><a href="shop?category=fancy">FANCY SAREES</a></li>
                    <li><a href="shop?category=bridal">BRIDAL SAREES</a></li>
                    <li><a href="shop?category=designer">DESIGNER SAREES</a></li>
                </ul>
            </div>
            ...
            <div class="site-footer__links-col">
                <div class="site-footer__group">
                    ...
                    <ul class="site-footer__nav-list">
                        ...
                        <li><a href="about#aboutIntro">OUR HERITAGE WAY</a></li>
                        <li><a href="contact#storeLocations">CONCEPT BOUTIQUE</a></li>
                        <li><a href="<?php echo htmlspecialchars(rk_article_url(2)); ?>">SILK MARK CERTIFIED</a></li>
                    </ul>
                </div>
            ...
            <div class="site-footer__links-col">
                <div class="site-footer__group">
                    ...
                    <ul class="site-footer__nav-list">
                        ...
                        <li><a href="policies#payments">PAYMENT METHODS</a></li>
                        <li><a href="policies#shipping">SHIPPING &amp; RETURNS</a></li>
                    </ul>
                </div>
                ...
                <div class="site-footer__group site-footer__group--services">
                    ...
                    <ul class="site-footer__nav-list">
                        <li><a href="contact#contactForm">CUSTOM BLOUSE FITTING</a></li>
                        <li><a href="https://wa.me/919876543210" target="_blank" rel="noopener">LIVE VIDEO SHOPPING</a></li>
                    </ul>
                </div>
            </div>
